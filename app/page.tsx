...
export default function Home(){
  ...
  const [paymentPlan,setPaymentPlan]=useState<"digital"|"physical"|"membership">("membership");
  ...
  const openPayment=()=>{setPaymentPlan("membership");setCheckoutError("");setPaymentOpen(true)};
