...
export default function TermsPage() {
  return (
    <main className="legal-page">
      ...
      <h2>The product</h2>
      <p>Results are AI-generated and may vary. Previews are watermarked or reduced-quality. The print-quality file is delivered after payment. Membership includes 20 regenerations and 2 physical sticker sheets shipped per billing period and does not guarantee a specific likeness.</p>
      <h2>Payments</h2>
