...
export default function RefundsPage() {
  return (
    <main className="legal-page">
      ...
      <p>Digital sticker packs are delivered immediately after payment. If generation failed or the download is broken, email hello@stickier.app and we will refund or regenerate that order.</p>
